...
parser = argparse.ArgumentParser(description='Bildweise Aufzeichnung von Filmen.')
parser.add_argument('-n', "--normal", action="store_true", help='normal film crop')
parser.add_argument('-s', "--super", action="store_true", help='super film crop')
...
with picamera.PiCamera() as camera:
    ...
    GPIO.setup(17, GPIO.IN) # Setup GPIO Pin 11 to shot input
    ...
    if not args.awb:
        ...
        camera.awb_gains = (args.gain_red, args.gain_blue)
